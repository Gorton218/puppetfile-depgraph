...
import { activate, deactivate, showTemporaryMessage } from '../../src/extension';
...
describe('Extension', () => {
    ...
    beforeEach(() => {
        ...
        const mockCodeLensProvider = require('../../src/puppetfileCodeLensProvider');
        ...
        const mockDiffCodeLensProvider = require('../../src/services/upgradeDiffCodeLensProvider');
    ...
    describe('apply upgrade commands', () => {
        ...
        test('should call PuppetfileCodeLensProvider.applySingleUpgrade for applySingleUpgrade command', async () => {
            ...
            // Assert
            expect(require('../../src/puppetfileCodeLensProvider').PuppetfileCodeLensProvider.applySingleUpgrade).toHaveBeenCalledWith(mockArgs);
        });
    ...
    describe('CodeLens provider registration', () => {
        ...
        test('should set static instances for CodeLens providers', () => {
            // Arrange
            const setInstanceSpy = jest.spyOn(require('../../src/puppetfileCodeLensProvider').PuppetfileCodeLensProvider, 'setInstance').mockImplementation(() => {});
            const setDiffInstanceSpy = jest.spyOn(require('../../src/services/upgradeDiffCodeLensProvider').UpgradeDiffCodeLensProvider, 'setInstance').mockImplementation(() => {});
